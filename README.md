...
The code is designed to skip any coloring quandles Q that are faithful. Indeed, every faithful quandle that satisfies condition (i) will not satisfy condition (ii); this can be seen by combining (4.3) with Lemma 4.2 in [this paper](https://arxiv.org/abs/1901.10996). See the Corollary in the MathOverflow answer for details.
